...
Distributed systems are designed to handle large-scale computations and storage across multiple servers or computers. These systems are indispensable when dealing with vast amounts of data that exceed the capacity of a single machine. The session begins with a discussion about why distributed systems are necessary, especially citing Amazon's growth from selling mere books to becoming a global e-commerce giant. This necessitated a shift from single-machine to distributed systems to handle enormous amounts of data efficiently【4:17†transcript.txt】.

Architecture of Hadoop Framework
Definition
Hadoop is essentially a framework that enables distributed processing of vast data sets across clusters of commodity servers. It uses simple programming models to handle complex tasks, making it scalable, reliable, and economical【4:9†handwritten.pdf】【4:7†transcript.txt】.
